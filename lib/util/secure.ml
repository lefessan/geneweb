...
*)
let open_in = check_open Stdlib.open_in
let open_in_bin = check_open Stdlib.open_in_bin
let open_out = check_open Stdlib.open_out
let open_out_bin = check_open Stdlib.open_out_bin
let open_out_gen mode perm = check_open (Stdlib.open_out_gen mode perm)
